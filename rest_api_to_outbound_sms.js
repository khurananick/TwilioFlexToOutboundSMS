/*
 * Use this function to create a flex chat conversation
 * after triggering a send and wait for reply via API.
 */
exports.handler = async function(context, event, callback) {
  ...
  if(event.Messages) {
      const messages = Object.values(JSON.parse(event.Messages)).reverse();
      const channel = client.chat.services(context.TWILIO_FLEX_CHAT_SERVICE_SID).channels(newChannel.sid);
